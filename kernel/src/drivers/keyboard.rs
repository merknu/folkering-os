...
const SCANCODE_TO_ASCII: [u8; 128] = [
    ...
    0, b' ', 0, 0x80, 0x81, 0x82, 0x83, 0x84,                    // 56-63 (alt, space, caps, F1=0x80..F5=0x84)
    0x85, 0x86, 0x87, 0x88, 0x89, 0, 0, b'7',                   // 64-71 (F6=0x85..F10=0x89, numlock, scroll, numpad)
...
const SCANCODE_TO_ASCII_SHIFT: [u8; 128] = [
    ...
    b'"', b'~', 0, b'|', b'Z', b'X', b'C', b'V',               // 40-47
    b'B', b'N', b'M', b'<', b'>', b'?', 0, b'*',               // 48-55
    0, b' ', 0, 0x80, 0x81, 0x82, 0x83, 0x84,                    // 56-63 (F1-F5 same shifted)
    0x85, 0x86, 0x87, 0x88, 0x89, 0, 0, b'7',                   // 64-71 (F6-F10)
    b'8', b'9', b'-', b'4', b'5', b'6', b'+', b'1',            // 72-79
    b'2', b'3', b'0', b'.', 0, 0, 0, 0,                        // 80-87
    0, 0, 0, 0, 0, 0, 0, 0,                                     // 88-95
    0, 0, 0, 0, 0, 0, 0, 0,                                     // 96-103
