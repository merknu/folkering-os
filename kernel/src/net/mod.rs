...
// ── UDP API ────────────────────────────────────────────────────────────
// Simple UDP send/recv for userspace. Each call creates a transient socket,
// sends/receives one packet, then closes. This is stateless from userspace's
// perspective — no socket handles to track. Suitable for DNS, NTP, mDNS, etc.
...
// ── NTP client ─────────────────────────────────────────────────────────
// Minimal SNTP (Simple NTP) client — sends a single request to an NTP
// server and parses the response to get current Unix timestamp.
